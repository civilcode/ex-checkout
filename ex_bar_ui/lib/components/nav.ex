defmodule ExBarUi.Component.Nav do
  ...
  def init( current_scene, opts ) do
    ...
    |> dropdown({[
        {"Sensor", ExBarUi.Scene.Sensor},
        {"Primitives", ExBarUi.Scene.Primitives},
        {"Components", ExBarUi.Scene.Components},
        {"Transforms", ExBarUi.Scene.Transforms},
